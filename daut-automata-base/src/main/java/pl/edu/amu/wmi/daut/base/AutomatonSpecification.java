...
abstract class AutomatonSpecification {
	 ...
	 * etykietowane etykietą transitionLabel,
	 * a następnie zwraca utworzony stan.
	 * @param from stan początkowy
	 * @param to nowo utworzony stan końcowy
	 * @return zwraca nowo utworzony stan
	 */
	 ...
	 * @param state stan początkowy i końcowy zarazem
	 * @param transitionLabel etykieta przejścia
	 */
