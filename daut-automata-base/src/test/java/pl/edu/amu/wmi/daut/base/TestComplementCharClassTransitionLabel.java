 ...
 *
 * @author s362606
 * Klasa tetująca ComplementCharClassTransitionLabel.
 */
...
public class TestComplementCharClassTransitionLabel extends TestCase{
    ...
    public final void testcanAcceptCharacter(){
        ...
        ComplementCharClassTransitionLabel test = new ComplementCharClassTransitionLabel("A-Ya-y0-8");
        ComplementCharClassTransitionLabel test1 = new ComplementCharClassTransitionLabel("A-Hakrwhelz46753");
    ...
    public final void testSimple(){
        ...
        ComplementCharClassTransitionLabel test = new ComplementCharClassTransitionLabel("");
    ...
    public final void testgetString(){
        ...
        ComplementCharClassTransitionLabel test1 = new ComplementCharClassTransitionLabel("abc");
        ComplementCharClassTransitionLabel test2 = new ComplementCharClassTransitionLabel("abcFHG5678");
        ComplementCharClassTransitionLabel test3 = new ComplementCharClassTransitionLabel("a-dA-G0-5");
    ...
    public final void testgetSet(){
        ...
        ComplementCharClassTransitionLabel test1 = new ComplementCharClassTransitionLabel("abG8");
        ComplementCharClassTransitionLabel test2 = new ComplementCharClassTransitionLabel("a-d0-5A-G");
    ...
    public final void testintersectWith(){
        ComplementCharClassTransitionLabel test1 = new ComplementCharClassTransitionLabel("a");
        ComplementCharClassTransitionLabel test2 = new ComplementCharClassTransitionLabel("a-b");
