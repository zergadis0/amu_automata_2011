...
public class TestNondeterministicAutomatonByThompsonApproach extends TestCase {
	...
	/**
         * Czwarty test (Od stanu początkowego odchodzą 3 epsilon-przejścia do trzech różnych stanów.      		 * Dopiero od owych trzech stanów występują "normalne" przejścia - tj. po znaku).
         */
	...
	/**
         * Piąty test (Do stanu początkowego prowadzą tylko epsilon przejścia. Występują pętle epsilon).      		 * 
         */
