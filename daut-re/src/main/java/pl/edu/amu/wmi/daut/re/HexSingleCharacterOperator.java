...
/**
 * Klasa reprezentująca pojedynczy konkretny znak o kodzie Unicode podanym w zapisie szesnastkowym.
 */
public class HexSingleCharacterOperator extends NullaryRegexpOperator {
    ...
    /**
     * Jako parametr przyjmuje char, jaki ma zaakceptować.
     */
    ...
    public static class Factory extends NullaryRegexpOperatorFactory {
        ...
        /**
         * Jako parametr przyjmuje ciąg "\x{ABC}", gdzie ABC = znaki 0..9, a..f .
         */
