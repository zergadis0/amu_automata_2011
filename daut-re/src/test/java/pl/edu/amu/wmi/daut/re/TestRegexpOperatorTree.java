...
public class TestRegexpOperatorTree extends TestCase {
    ...
    public final void testLeaf() {
        RegexpOperator nullOperator = (new DigitOperator.Factory()).createOperator(new ArrayList<String>());
        
        RegexpOperatorTree rOT = new RegexpOperatorTree(nullOperator, new ArrayList<RegexpOperatorTree>());
